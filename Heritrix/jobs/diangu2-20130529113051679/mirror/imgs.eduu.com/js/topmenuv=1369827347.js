// JavaScript Document
document.writeln("<link href='"+ecfg.img+"css/public_topnav.css?2012-3-20' type='text/css' rel='stylesheet' />");
document.writeln("<link href='"+ecfg.img+"css/login_topnav.css' type='text/css' rel='stylesheet' />");
document.writeln("<div id='eduuTopNav' class='topnavI'>");
document.writeln("    <div class='wrapperUser'>");
document.writeln("        <div class='topNavL'>");
document.writeln("            <ul>");
document.writeln("               <li id='eduuTopIndex'><a href='http://www.aoshu.com/'><i>e</i>度教育网</a></li>");
document.writeln("               <li class='noPa' style='_width:73px;'>");
document.writeln("                   <dl class='tarBox otherWebsite' xd='navOn' id='m001'>");
...
document.writeln("                <li><a href='"+ecfg.homeurl+"'>空间</a></li>");
document.writeln("                <li class='noPa' style='_width:49px;'>");
document.writeln("                   <dl class='tarBox apply' xd='navOn' id='m002'>");
document.writeln("                        <dt>应用<i></i></dt>");
document.writeln("                        <dd>");
//document.writeln("                            <a href='http://www.aoshu.com/tiku/'><s class='w10'></s>题库</a><a href='http://zidian.eduu.com/'><s class='w11'></s>字典</a><a href='http://cidian.eduu.com/'><s class='w12'></s>词典</a><a href='http://chengyu.eduu.com/'><s class='w13'></s>成语</a><a class='xsc' onclick=\"_gaq.push(['_trackEvent' ,'xzs_login', 'home' ],['a._trackEvent' ,'xzs_login', 'home' ]);\" href='http://apps.eduu.com/xiaoshengchu/'><s class='w19'></s>小升初</a>");
...
document.writeln("                </li>");
document.writeln("                <li class='noPa' style='_width:73px;'>");
document.writeln("                   <dl class='tarBox coach' xd='navOn' id='m003'>");
...
document.writeln("                    </dl>");
document.writeln("                </li>");
document.writeln("                <li class='navSrh'><form method=get action='http://s.eduu.com/qs' target='_blank'><input type='hidden' id='eduTG' name='tg' value='0' /><input type='hidden' id='cateid' name='cid' value='3' /><input name='wd' id='eduuwd' type=text size='20' class='topInput' onfocus=\"this.value='';this.style.color='#000000';\" onblur=\"if(!this.value){this.value='请输入您要查询的关键字';this.style.color='#BBBBBB';}\" value='请输入您要查询的关键字' /><input name='' type='image' src='http://img.eduuu.com/website/public_images/topmenu/nav_btn_srh.gif' onclick='if(document.getElementById(\"eduuwd\").value==\"请输入您要查询的关键字\"){ document.getElementById(\"eduuwd\").value=\"\"}'/></form></li>");
document.writeln("            </ul>");
...
document.writeln("                </li>");
document.writeln("                <li>");
document.writeln("                    <a class='top_q_Login' href='#' onclick=\"javascript:apiLogin(4,'"+ecfg.regurl+"');_gaq.push(['_trackEvent' ,'login', 'qq', 'step-1']);\"></a>");
document.writeln("                    <a class='top_w_Login' href='#' onclick=\"javascript:apiLogin(1,'"+ecfg.regurl+"');_gaq.push(['_trackEvent' ,'login', 'sina', 'step-1']);\"></a>");
document.writeln("                </li>");
document.writeln("            </ul>");
document.writeln("        </div>");
...
document.writeln("                   <dl class='tarBox launch' xd='launchOn' id='m004'>");
document.writeln("                        <dt>发布<i></i></dt>");
document.writeln("                        <dd>");
document.writeln("                            <a href='"+ecfg.url+"blog/add/'>写日记</a><a href='"+ecfg.url+"album/upload/'>传照片</a><a href='http://bbs.eduu.com/home.php?mod=space&do=thread&view=me'>发帖子</a><a href='"+ecfg.url+"tougao/add/'>投作文</a>");
...
document.writeln("                </li>");
document.writeln("                <li class='noPa' style='_width:69px;'>");
document.writeln("                   <dl class='tarBox set' xd='setOn' id='m005'>");
document.writeln("                        <dt>设置<i></i></dt>");
document.writeln("                        <dd>");
document.writeln("                            <a href='"+ecfg.url+"profile/index/'>个人资料</a><a href='"+ecfg.url+"account/passwd/'>账号安全</a><a href='"+ecfg.url+"help/index/'>空间设置</a><a href='"+ecfg.url+"bbs/usersign/'>论坛设置</a><a href='"+ecfg.regurl+"logout'>退出</a>");
document.writeln("                            <iframe width='110' height='120' style='position:absolute; left:-2px; top:28px; z-index:-1; filter:alpha(opacity=0); background:transparent;border:0pt none;' frameborder='0'></iframe>");
document.writeln("                        </dd>");
document.writeln("                    </dl>");
document.writeln("                </li>");
document.writeln("                <li class='noPa' style='_width:73px;'>");
...
document.writeln("                        <dd>");
document.writeln("                            <a href='"+ecfg.url+"msg'>站内信<em></em><a href='"+ecfg.url+"notice/interaction'>互动请求<em></em></a><a href='"+ecfg.url+"friend/fans'>新增粉丝<em></em></a><a href='"+ecfg.url+"notice/system'>系统通知<em></em></a><a href='"+ecfg.url+"'>好友新鲜事<em class='hasOrg'>new!</em></a>");
document.writeln("                            <iframe width='110' height='120' style='position:absolute; left:-2px; top:28px; z-index:-1; filter:alpha(opacity=0); background:transparent;border:0pt none;' frameborder='0' ></iframe>");
document.writeln("                        </dd>");
document.writeln("                    </dl>");
document.writeln("                </li>");
...
document.writeln("                                <div>");
document.writeln("                                <p><a href='"+ecfg.homeurl+"' class='level'>小牛妈妈521</a></p><!--等级增加时变换class='levelIcon1-22'-->");
...
document.writeln("                                <p><a href='"+ecfg.url+"' class='enterHome'>进入个人中心</a></p>");
//document.writeln("                                <p><a class='vip_link_btn' href='http://vip.eduu.com?ref=user_menu' target='_blank'><span>开通会员</span></a></p>");
document.writeln("                                <ul class='n_menubox'>");
document.writeln("                                    <li><a href='"+ecfg.url+"blog'>我的日志</a></li>");
document.writeln("                                    <li><a href='"+ecfg.url+"album'>我的相册</a></li>");
document.writeln("                                    <li>");
document.writeln("                                        <a href='"+ecfg.url+"forum/all'>我的帖子</a>");
document.writeln("                                        <p class='n_gary'><a href='"+ecfg.url+"forum/thread'>我的主题</a><a href='"+ecfg.url+"forum/post'>我的回复</a><a href='http://bbs.eduu.com/home.php?mod=space&do=thread&view=me&type=postcomment'>我的点评</a><a href='http://bbs.eduu.com/home.php?mod=space&do=thread&view=digest'>我的精华</a></p>");
document.writeln("                                    </li>");
document.writeln("                                    <li><a href='"+ecfg.url+"share/listyou'>我的分享</a></li>");
document.writeln("                                    <li><a href='"+ecfg.url+"share/listme'>我的收藏</a></li>");
document.writeln("                                    <li><a href='"+ecfg.url+"tougao'>我的投稿</a></li>");
document.writeln("                                </ul>");
document.writeln("                            </div>");
...
document.writeln("    </div>");
document.writeln("</div>");
document.writeln("<script type=\"text/javascript\" src=\"http://img.eduuu.com/edu/js/ggc.js?gx=2012_11\"></script>");

(function($){
    var _gcc =[{domain:'eduu.com',name:'e度教育网',sid:'0'},{domain:'aoshu.com',name:'奥数网首页',sid:'1'},{domain:'zuowen.com',name:'作文网首页',sid:'98'},{domain:'yingyu.com',name:'英语网首页',sid:'4'},{domain:'gaokao.com',name:'高考网首页',sid:'3'},{domain:'youjiao.com',name:'幼教网首页',sid:'5'},{domain:'liuxue.com',name:'留学网首页',sid:'99'},{domain:'zhongkao.com',name:'中考网首页',sid:'2'},{domain:'yuer.com',name:'育儿网首页',sid:'100'}],gccHost;
...
function API_loging(O){
    ...
    $('#eduuUser').find('p:eq(0) > a').addClass('levelIcon'+O.ugid).text(O.uname).attr('href',ecfg.homeurl+O.uid+'/');
    ...
    $(".fansnum").attr("href",ecfg.homeurl+O.uid+"/friend/fans/");
    $(".follnum").attr("href",ecfg.homeurl+O.uid+"/friend/");

    //切换小升初助手的链接地址
    $(".xsc").attr("href",ecfg.url+"xiaoshengchu/");

    //验证是否e度会员
    //if(O.isvip>0) $(".vip_link_btn span").text("进入会员中心");
}
...
function subLogin(){
    ...
    /*
    $.each(uname,function(i){
        if("@".indexOf(uname[i])>=0){
            logtype=2;
        }
    });*/
