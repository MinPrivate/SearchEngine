// JavaScript Document
document.writeln("<link href='http://img.eduuu.com/aoshu/css/public_topnav.css?2012-3-23' type='text/css' rel='stylesheet' />");
...
//春节背景
$(function(){
	$('.cjbg-close').click(function(){
		$('.cjbg-close').hide().parent().removeClass();
		$('body').removeClass();
	})	
})